    ...
    return (
        <div className='overflow-auto py-24 sm:overflow-hidden sm:py-32'>
                                ...
                                return (
                                    <button
                                        className={cn(
                                            ...
                                            index === carouselIndex ? 'bg-zinc-900 text-white dark:bg-zinc-50 dark:text-zinc-900' : ''
                                        )}
                                        key={index}
                                        type='button'
            ...
            <Carousel index={carouselIndex} onIndexChange={setCarouselIndex} disableDrag>
                <CarouselContent className='w-full md:-ml-5' transition={{ ease: [0.77, 0, 0.175, 1], duration: 1, }}>
                    {FEATURES.map(
                        (feature, index) => (
                            <CarouselItem className='flex items-center justify-center px-2' key={index}>
