                ...
                <div className='flex flex-col lg:grid lg:grid-cols-2'>
                    ...
                    <div className='p-0 sm:p-8 lg:p-16'>
                        <Accordion
                            ...
                            onValueChange={(value) => { if (!value) return; setActiveAccordionId(value as string); }}
                        >
                            {FEATURES.map(
                                (item) => (
...
const FEATURES = [ // images from https://www.cosmos.so/e/1861677771
    {
        id: 'item1',
        title: 'Text-to-image generation',
        content: 'Transform your ideas into stunning visuals with our advanced text-to-image AI. Simply describe what you want, and watch as our algorithm brings your imagination to life in high-resolution images.',
        image: 'https://images.beta.cosmos.so/979ffbcb-0354-47d0-9301-a292f591528f?format=jpeg',
    }, {
        id: 'item2',
        title: 'Style transfer & customization',
        content: 'Apply and blend various artistic styles to your generated images. From renaissance to modern art, our AI can adapt your creations.',
        image: 'https://images.beta.cosmos.so/613cf988-5f71-4e10-a208-9bf394874a61?format=jpeg',
    }, {
        id: 'item3',
        title: 'Infinite resolution scaling',
        content: 'Never worry about image quality again. Our AI can intelligently upscale your generated images to any resolution without loss of detail, ensuring your creations always look crisp and professional.',
