...
export function Feature13() {
  ...
  return (
    <div className='relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
      ...
      <div className='md:hidden'>
        <div className='h-screen snap-y snap-mandatory overflow-y-auto py-24 sm:py-32'>
          {FEATURES.map((feature, index) => (
            <div
              key={index}
              className='mb-12 flex min-h-screen snap-center items-center'
            >
      ...
      {/* Desktop layout */}
      <div
        className='relative hidden grid-cols-1 gap-8 md:grid md:h-[300vh] md:grid-cols-2 md:gap-16 lg:gap-32'
        ref={containerRef}
      >
