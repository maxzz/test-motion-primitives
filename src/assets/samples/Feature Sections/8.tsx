...
const FEATURES = [
    {
        tab: 'Design',
        content: (<FeatureImg key='design' src='https://cdn.cosmos.so/8bb8b6e6-1658-4c42-bc5d-e8d17394bb01?format=jpeg' alt='Design' />),
    }, {
        tab: 'Engineering',
        content: (<FeatureImg key='engineering' src='https://cdn.cosmos.so/c50a75a4-b145-4044-9406-c89d5c326382?format=jpeg' alt='Engineering' />),
    }, {
        tab: 'AI',
        content: (<FeatureImg key='ai' src='https://cdn.cosmos.so/1437d5d6-52e0-465e-9dfd-c92352d7507e?format=jpeg' alt='AI' />),
    }, {
        tab: 'Marketing',
        content: (<FeatureImg key='marketing' src='https://cdn.cosmos.so/ed170ddf-b6f3-4865-a38e-1304c5197eeb?format=jpeg' alt='Marketing' />),
    }, {
        tab: 'Analytics',
        content: (<FeatureImg key='analytics' src='https://cdn.cosmos.so/6b1ae75e-af71-4349-8a24-a2f7945b371f?format=jpeg' alt='Analytics' />),
    },
];
