...
export function Feature12() {
    ...
    return (
        <div
            ...
            style={{ '--section-height': `${FEATURES.length * 100}vh`, } as React.CSSProperties}
        >
            <div className='sticky top-0 flex h-screen items-center justify-center'>
                <div className='mx-auto max-w-7xl px-6 lg:px-8'>

                    <div ref={containerRef} className='grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-16 lg:gap-32'>
