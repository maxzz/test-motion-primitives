                ...
                <div className="flex-1 flex flex-row items-center gap-5">
                    ...
                    <TextEffect
                        ...
                        segmentWrapperClassName="
                            [&>*]:bg-gradient-to-b [&>*]:from-[#e4d3e8] [&>*]:via-[#afe1f0] [&>*]:to-[#e4d3e8] 
                            [&>*]:bg-clip-text 
                            [&>*]:text-transparent"
...
const loadingPhases = [
    ...
    { isLoading: false, label: "Analyzing scope..." },
    { isLoading: false, label: "Synthesizing solutions..." },
    { isLoading: false, label: "Finalizing output..." },
];
