...
const ITEMS = [
  {
    img: 'https://images.beta.cosmos.so/ef796418-a1ca-4b0b-8536-60a9e3a01449?format=jpeg',
    alt: 'cosmos',
    position: {
      left: '30%',
      top: '0%',
    },
    multiplier: { x: -0.08, y: -0.02 },
  },
  {
    img: 'https://images.beta.cosmos.so/d5c3850c-7a85-4e46-b61f-059aa1300f77?format=jpeg',
    alt: 'cosmos',
    position: {
      left: '10%',
      top: '50%',
    },
    multiplier: { x: -0.05, y: -0.09 },
  },
  {
    img: 'https://images.beta.cosmos.so/46a3308c-db18-484d-9421-2c68b71814b7?format=jpeg',
    alt: 'cosmos',
    position: {
      left: '30%',
      top: '90%',
    },
    multiplier: { x: -0.03, y: -0.06 },
  },
  {
    img: 'https://images.beta.cosmos.so/d5acdfdf-8785-43f6-bc55-0c686812b3bd?format=jpeg',
    alt: 'cosmos',
    position: {
      left: '70%',
      top: '10%',
  ...
  {
    img: 'https://images.beta.cosmos.so/b7ecaea1-230a-4779-a45c-517c1594982d?format=jpeg',
    alt: 'cosmos',
    position: {
      left: '90%',
      top: '50%',
  ...
  {
    img: 'https://images.beta.cosmos.so/bab29ee2-aa17-41b5-b66e-a985e9307b1b?format=jpeg',
    alt: 'cosmos',
    position: {
      left: '70%',
      top: '85%',
...
function FloatingImage({
  ...
  mouseX.on('change', (latest) => {
    springX.set(latest * multiplier.x);
  });

  mouseY.on('change', (latest) => {
    springY.set(latest * multiplier.y);
  });
...
// images from https://www.cosmos.so/satorifiles/graphic-design
