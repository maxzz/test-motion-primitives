                ...
                <div className='mx-auto max-w-2xl py-32 sm:py-48 lg:py-56'>
                    ...
                    <div className='hidden sm:mb-8 sm:flex sm:justify-center'>
                        ...
                        >
                            ...
                            <a href='#' className='inline-flex items-center gap-1 font-semibold text-zinc-600 dark:text-zinc-400'>
                    ...
                    <div className='text-center'>
                        ...
                        <TextEffect
                            ...
                            segmentTransition={{ duration: 0.5, ease: 'easeOut' }}
                        >
                            Create stunning, professional websites with unparalleled ease. Leverage our intuitive tools and thoughtfully crafted components.
                        </TextEffect>
