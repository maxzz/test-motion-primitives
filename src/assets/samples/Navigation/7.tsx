        ...
        <div className='py-24 sm:py-32'>
            <div className='mx-auto max-w-7xl px-6 lg:px-8'>
                <div className='flex justify-center'>
                    <div ref={containerRef} className='relative flex max-w-full overflow-x-auto border-b border-zinc-200 dark:border-zinc-800'>

                        <motion.div
                            className='absolute bottom-0 h-0.5 bg-black dark:bg-white'
                            layoutId='underline'
                            animate={{ x: offsetLeft, width: offsetWidth, }}
